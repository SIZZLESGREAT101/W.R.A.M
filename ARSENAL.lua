...
ping.Text = "\"Right-Shift\" for menu"
...
quotasname.BackgroundColor3 = Color3.fromRGB(34, 34, 34)  -- Dark background for contrast
quotasname.BackgroundTransparency = 0.2  -- Slight transparency for a smooth look
quotasname.BorderColor3 = Color3.fromRGB(255, 165, 0)  -- Orange border for emphasis
quotasname.BorderSizePixel = 2  -- Thicker border for visual impact
quotasname.Position = UDim2.new(0.5, -164, 0, 10)  -- Centered position with a little margin
quotasname.Size = UDim2.new(0, 329, 0, 35)  -- Larger size for better readability
quotasname.Font = Enum.Font.GothamBold  -- Bold font for a modern feel
quotasname.Text = "\"W.R.A.M\""  -- Keeping the same text
quotasname.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White text for contrast
quotasname.TextSize = 18  -- Larger text size for better visibility
quotasname.TextWrapped = true
quotasname.TextStrokeTransparency = 0.8  -- Adds stroke for better readability
quotasname.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)  -- Black stroke to enhance text
quotasname.TextXAlignment = Enum.TextXAlignment.Center  -- Center-align the text horizontally
quotasname.TextYAlignment = Enum.TextYAlignment.Center  -- Center-align the text vertically
